<%@ Page Title="" Language="C#" MasterPageFile="~/left_baner_footer.master" AutoEventWireup="true" CodeFile="TrangOpLung.aspx.cs" Inherits="TrangOpLung" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    ...
    <asp:DataList ID="DataList1" CssClass="datalist" runat="server" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4"  GridLines="Horizontal" RepeatColumns="3" RepeatDirection="Horizontal" OnSelectedIndexChanged="DataList1_SelectedIndexChanged">
            ...
            <table style="border: thin double #008000; margin-top:20px; width:100%; background-color:#def4f4; font-family: 'Times New Roman', Times, serif; text-transform: capitalize; color: #000000;" >
                <tr>
                    <td class="text-center" colspan="2">
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("Hang") %>' />
                    </td>
                </tr>
                <tr>
                    <td colspan="2" class="auto-style8">
                        <asp:Label ID="Label2" runat="server"  Text='<%# Eval("Ten") %>' />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:Label ID="Label3" runat="server" ForeColor="Red" Text='<%# Eval("DonGia") %>' Font-Italic="False" Font-Underline="True" />
                        <asp:Label ID="Label4" runat="server" ForeColor="Red" Text="vnđ"></asp:Label>
                    </td>
                    <td>
                        <div class="mua">
                            <a class="center" style="color:red" href="ChiTietSanPham.aspx?MaSp=<%# Eval("MaOpLung") %><%# Eval("Ten") %>" >MUA NGAY</a>
     ...
     <%--<asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:QL_linhKienDienThoaiConnectionString %>" SelectCommand="SELECT * FROM [OpLung]"></asp:SqlDataSource>
     <%--<a--%>
    <%--sp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:QL_linhKienDienThoaiConnectionString %>" SelectCommand="SELECT [Ten], [Hang], [HinhMinhHoa], [DonGia],MaOpLung FROM OpLung"></asp:SqlDataSource>--%>
