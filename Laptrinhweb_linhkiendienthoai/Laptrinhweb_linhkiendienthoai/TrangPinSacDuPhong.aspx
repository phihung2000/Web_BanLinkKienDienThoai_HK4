<%@ Page Title="" Language="C#" MasterPageFile="~/left_baner_footer.master" AutoEventWireup="true" CodeFile="TrangPinSacDuPhong.aspx.cs" Inherits="TrangPinSacDuPhong" %>
    ...
    <table style="width:850px;background-color:#EE7600; margin-top:-20px;margin-bottom:-10px" >
        <tr>
            ...
            <td class="auto-style5">
                &nbsp;</td>
             <td class="auto-style5">
                 <asp:Button ID="Button2" runat="server" Text="10.000mAh" Font-Size="Small" Font-Strikeout="False" Width="120px" OnClick="Button2_Click" />
            </td>
            <td class="auto-style5">
                &nbsp;</td>
           ...
           <table style="border: thin double #008000; margin-top:20px; width:100%; background-color:#def4f4; font-family: 'Times New Roman', Times, serif; text-transform: capitalize; color: #000000;" >
                ...
                <tr>
                    <td colspan="2" class="auto-style8">
                        <asp:Label ID="TenLabel" runat="server"  Text='<%# Eval("TenCucSac") %>' />
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <div class="mua">
                            <a class="center" style="color:red" href="ChiTietSanPham.aspx?MaSp=<%# Eval("MaCucSac") %><%# Eval("TenCucSac") %>" >MUA NGAY</a>
